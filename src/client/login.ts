...
function loginInit(): void {
  ...
  const nicknameError = document.getElementById("nicknameError") as HTMLElement | null;
  const loginBtn = document.getElementById("loginBtn") as HTMLButtonElement | null;

  if (!form || !nicknameInput || !nicknameError || !loginBtn) return;
